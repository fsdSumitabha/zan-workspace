...
const routePermissions: Array<{ pattern: RegExp; roles: number[] }> = [
    { pattern: /^\/admin\/operations\/users(\/|$)/, roles: [10,45, 20, 69] },
    { pattern: /^\/admin\/operations\/users\/create(\/|$)/, roles: [10, 20, 69] },
    { pattern: /^\/admin\/operations\/users\/[^\/]+\/edit(\/|$)/, roles: [10, 20] },
    { pattern: /^\/admin\/operations\/leads\/create(\/|$)/, roles: [10, 15, 45, 50, 60, 69, 70] },
    { pattern: new RegExp(`^/admin/operations/leads/${OBJECT_ID}/convert(/|$)`), roles: [10,45, 60, 69, 70], },

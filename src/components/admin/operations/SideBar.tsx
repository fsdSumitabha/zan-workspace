...
const navItems = [
    { name: "Dashboard", href: "/admin/operations", icon: Home, roles: [10, 15, 20, 30, 40, 42, 45, 50, 60, 69, 70, 80] },
    { name: "Leads", href: "/admin/operations/leads", icon: Target, roles: [10, 15, 20, 30, 40, 42, 45, 50, 60, 69, 70, 80] },
    ...
    { name: "Meetings", href: "/admin/operations/meetings", icon: CalendarClock, roles: [10, 15, 20, 30, 40, 42, 45, 50, 60, 69, 70, 80] },
